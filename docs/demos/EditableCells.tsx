...
const columns: ApexColumnDef<Item>[] = [
  ...
  { accessorKey: 'color', header: '颜色', size: 160, meta: { apex: { editor: { type: 'ColorPicker', props: { presets: [{ label: '常用颜色', colors: ['#5890d9', '#f97316', '#16a34a'] }] } } } } },
  ...
  { accessorKey: 'image', header: '图片', size: 270, meta: { apex: { editor: { type: 'Image', props: { inputProps: { placeholder: '输入图片地址' } } } } } },
];
